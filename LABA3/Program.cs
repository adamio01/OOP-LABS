...
namespace lab_3
{
    ...
    {
        static void Main(){
            // Создаем коллекцию журналов и заполняем её
            ...
            // Сортируем коллекцию разными методами и выводим полученное
